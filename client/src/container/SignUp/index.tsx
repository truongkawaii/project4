    ...
    <div className="col-lg-5 col-md-12">
      <div className="box">
        ...
        <div className="form">
          ...
          <div className="dn"><a href="a">Đăng Ký</a></div>
          <p>
            <a href="a">Bạn đã có tài khoản? <span /></a><a href = "a">Đăng nhập</a>
          </p>
          <br />
          <p>Bạn gặp khó khăn khi tạo tài khoản</p>
          <p>
            Vui lòng gọi tới số <span>(024) 6680 5588</span>(giờ hành chính) để
            được hỗ trợ.
          </p>
        </div>
      </div>
