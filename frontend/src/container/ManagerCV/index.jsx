      ...
      <div className="item-right">
        <div className="item-right-info">
          <div className="card-info-cv">
            <img
              src="https://graph.facebook.com/588533928647141/picture?type=large"
              alt=""
            />
          ...
          <div className="list-info-cv">
           ...
           <p>Cho phép các Nhà tuyển dụng đã được BotCV xác thực xem CV Online để có thể liên hệ với bạn</p>
            <h4>Khởi tạo BotCV Profile để gia tăng 300% cơ hội việc làm tốt</h4>
            <h3>Tạo BotCV profile</h3>
          </div>
        </div>
